...
/**
 * @dev network_config object contains informations about a few networks like Ethereum mainnet, Ethereum Sepolia,...
 * @notice '1', '5',... is the chainId of each network(mainnet, sepolia, ...)
 *
 */
